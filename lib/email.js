            ...
            html: `
                <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
                    ...
                    <div style="background: #111; padding: 32px; border-radius: 0 0 16px 16px;">
                        <p style="color: #ccc; line-height: 1.7;">Hi ${escapeHtml(customerName)},</p>
                        <p style="color: #ccc; line-height: 1.7;">Your appointment is locked in. Here's what you need to know:</p>
                        <table style="width: 100%; margin: 24px 0; border-collapse: collapse;">
                            <tr><td style="padding: 8px 0; color: #888;">Service</td><td style="padding: 8px 0; color: #fff; text-align: right; font-weight: 600;">${escapeHtml(service)}</td></tr>
                            <tr><td style="padding: 8px 0; color: #888; border-top: 1px solid #222;">Date</td><td style="padding: 8px 0; color: #fff; text-align: right; border-top: 1px solid #222;">${escapeHtml(bookingDate)}</td></tr>
                            <tr><td style="padding: 8px 0; color: #888; border-top: 1px solid #222;">Time</td><td style="padding: 8px 0; color: #fff; text-align: right; border-top: 1px solid #222;">${escapeHtml(bookingTime)}</td></tr>
                            <tr><td style="padding: 8px 0; color: #888; border-top: 1px solid #222;">Price</td><td style="padding: 8px 0; color: #fff; text-align: right; border-top: 1px solid #222; font-weight: 700;">${escapeHtml(priceStr)}</td></tr>
                        </table>
                        ${address ? `<p style="color: #888; font-size: 0.9rem;">Location: ${escapeHtml(address)}</p>` : ''}
